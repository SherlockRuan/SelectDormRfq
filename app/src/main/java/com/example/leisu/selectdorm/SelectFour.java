...
public class SelectFour extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.sel_4_start) {
            ...
            stu1id = tongzhuren1_xh.getText().toString();
            v1code = tongzhuren1_yz.getText().toString();
            stu2id = tongzhuren2_xh.getText().toString();
            v2code = tongzhuren2_yz.getText().toString();
            stu3id = tongzhuren3_xh.getText().toString();
            v3code = tongzhuren3_yz.getText().toString();
            jsonPost();
        }
    }
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    ClientKey.put("stu3id", stu3id);
                    ClientKey.put("v3code", v3code);
